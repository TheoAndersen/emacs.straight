...
(face-remap-add-relative 'highlight 'hi-line)
...
(when (eq window-system 'x)
  ...
  (let ((font "source code pro"))
    ...
    (set-face-attribute 'mode-line nil :font font :height 60)
    (set-face-attribute 'mode-line-inactive nil :font font :height 60)
    (set-face-attribute 'term nil :font font :height 80))
  (custom-set-faces
     (set-face-attribute 'neo-button-face      nil :height 70)
     (set-face-attribute 'neo-file-link-face   nil :height 70)
     (set-face-attribute 'neo-dir-link-face    nil :height 70)
     (set-face-attribute 'neo-header-face      nil :height 70)
     (set-face-attribute 'neo-expand-btn-face  nil :height 70)
     (set-face-attribute 'neo-banner-face      nil :height 70)
     (set-face-attribute 'neo-root-dir-face    nil :height 70)
     )
  )
